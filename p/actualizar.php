<?php 
    ...
    $con=conectar();
    $id=$_GET['Ped_ID'];
    $sql="SELECT * FROM pedidos WHERE Ped_ID='$id'";
    ...
    <br>
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                            ...
                            <input type="hidden" class="form-control mb-3" name="Ped_ID" placeholder="ID Pedido" value="<?php echo $row['Ped_ID']  ?>">
                                <select name="cli_id" placeholder="cli_id" class="form-control mb-3">
                                ...
                                <select name="Prod_ID" placeholder="Prod_ID" class="form-control mb-3">
                                ...
                                <input type="text" class="form-control mb-3" name="Qtd" placeholder="Cantidad" value="<?php echo $row['Qtd']  ?>">
                                <select name="rdy" placeholder="Pedido Preparado?" class="form-control mb-3">
                                    <option value="<?php echo $row['rdy']  ?>">Pedido Preparado?</option>
                                    <option value="0">No</option>
                                    <option value="1">Sí</option>
                                </select>
                                <select name="delive" placeholder="Pedido Entregado?" class="form-control mb-3">
                                    <option value="<?php echo $row['delive']  ?>">Pedido Entregado?</option>
                                    <option value="0">No</option>
                                    <option value="1">Sí</option>
                                </select>
                                <input type="text" class="form-control mb-3" name="Delive_addr" placeholder="Dirección de envio" value="<?php echo $row['Delive_addr']  ?>">                   
